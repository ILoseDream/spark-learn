...
public class Repartition {
  ...
  public static void main(String[] args) {
    ...
    // 但是repartition可以将rdd的 partition 变多
    ...
    JavaRDD<String> staffRDD = sparkContext.parallelize(staffList, 3);
    ...
    staffRDD2.collect().forEach(System.out::println);

    staffRDD2.repartition(6);
    JavaRDD<String> staffRDD4 = staffRDD2.mapPartitionsWithIndex(
        new Function2<Integer, Iterator<String>, Iterator<String>>() {
          @Override
          public Iterator<String> call(Integer index, Iterator<String> iterator) throws Exception {
            List<String> list = new ArrayList<>();
    ...
    staffRDD4.collect().forEach(System.out::println);
    sparkContext.close();
  }
