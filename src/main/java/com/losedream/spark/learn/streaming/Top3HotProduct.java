...
public class Top3HotProduct {
  ...
  public static void main(String[] args) {
    ...
    // 获取输入数据流
    JavaReceiverInputDStream<String> productClickLogsDStream = streamingContext.socketTextStream(
        "spark1",
        9999);
    ...
    JavaPairDStream<String, Integer> categoryProductPairsDStream = productClickLogsDStream.mapToPair(
        new PairFunction<String, String, Integer>() {
          ...
          public Tuple2<String, Integer> call(String productClickLog) throws Exception {
            String[] productClickLogSplit = productClickLog.split(" ");
            return new Tuple2<String, Integer>(productClickLogSplit[2] + "_" +
                productClickLogSplit[1], 1);
          }
        });
